      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`rounded-2xl p-8 relative transition-all duration-300 transform hover:-translate-y-2 ${
                plan.highlighted
                  ? 'bg-gradient-to-br from-indigo-600 via-blue-600 to-purple-600 text-white shadow-2xl scale-105 ring-2 ring-white hover:shadow-3xl'
                  : 'bg-white border border-zinc-200 text-zinc-900 shadow-sm hover:shadow-xl hover:border-indigo-200'
              }`}
            >
              {/* Badge */}
              {plan.highlighted && (
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <details key={i} className="group bg-white border border-zinc-200 rounded-lg p-6 cursor-pointer hover:border-indigo-200 hover:shadow-md transition-all">
                <summary className="flex justify-between items-center font-semibold text-zinc-900 group-open:text-indigo-600 list-none">
                  {faq.q}
                  <span className="transition-transform duration-300 group-open:rotate-180 text-zinc-400 group-open:text-indigo-600">▼</span>
                </summary>
