...
const ShareModal = ({ onClose }) => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('https://clip.sync/s/f7k2m9x');
    setCopied(true);
    ...
    <div className="fixed inset-0 bg-black/20 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="px-6 py-4 bg-zinc-50 border-t border-zinc-100">
          <button className="w-full py-3.5 bg-zinc-900 text-white rounded-xl font-semibold hover:bg-zinc-800 transition-all duration-150 hover:scale-[1.02] active:scale-[0.98]">
            Create Share Link
          </button>
        </div>
      </div>
