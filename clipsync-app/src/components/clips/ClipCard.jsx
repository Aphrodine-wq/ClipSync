...
const ClipCard = ({ clip, onShareClick }) => {
  ...
  const handleCopy = async (e) => {
    ...
    try {
      ...
      toast.error('Failed to copy clip', 'Error');
    }
  };
  ...
  const handlePin = async (e) => {
    ...
    try {
      ...
      toast.success(clip.pinned ? 'Clip unpinned' : 'Clip pinned!', 'Success');
    } catch (error) {
      console.error('Failed to toggle pin:', error);
      toast.error('Failed to pin clip', 'Error');
    }
  };
  ...
  const handleDelete = async (e) => {
    ...
    setTimeout(async () => {
      try {
        ...
        toast.success('Clip deleted', 'Success');
      } catch (error) {
